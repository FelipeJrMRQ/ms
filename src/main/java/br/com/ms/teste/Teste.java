...
public class Teste implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		System.out.println(java.util.Calendar.getInstance(TimeZone.getDefault()).getTime());
	}
	...
	public static void main(String[] args) throws KeyManagementException, UnrecoverableKeyException, KeyStoreException, NoSuchAlgorithmException, Exception {
		...
		try {
			...
			String ntpServer = "1.africa.pool.ntp.org";// servidor de horario brasileiro
...
//		Teste t = new Teste();
//		JobDetail job = JobBuilder.newJob(t.getClass()).withIdentity("teste").build();
//		ScheduleUtil.start(job, "0 */20 * * * ?", "GRUPO", "G1");
